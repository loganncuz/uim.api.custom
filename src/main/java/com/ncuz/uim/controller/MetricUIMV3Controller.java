...
import com.ncuz.uim.service.MetricUIMV3Service;
...
public class MetricUIMV3Controller {
    @Autowired
    MetricUIMV3Service metricUIMService;
    @Autowired
...
//            logger.debug("");
        ...
        try {
            ...
            logger.debug("### PROCESS ID :" + proccessID + " - REQUEST METRICS FINISH ####################################################");
            logger.debug("");
            periodDecode = null;
            targetDecode = null;
            idDecode = null;
